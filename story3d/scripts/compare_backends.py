...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare qREST backend master CSV files.")
    parser.add_argument("--case", required=True, help="Case output directory containing backend subdirs.")
    parser.add_argument("--a", default="direct_stiffness/master_response.csv")
    parser.add_argument("--b", default="opensees_story/master_response.csv")
