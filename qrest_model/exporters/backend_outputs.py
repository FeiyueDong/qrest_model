...
def write_story3d_outputs(result: dict[str, Any], output_dir: str | Path, *, stiffness_key: str = "stiffness_matrix") -> None:
    ...
    write_matrix(output / "stiffness_matrix.txt", result[stiffness_key])
...
def write_shear_outputs(result: dict[str, Any], output_dir: str | Path) -> None:
    output = ensure_output_dir(output_dir)
