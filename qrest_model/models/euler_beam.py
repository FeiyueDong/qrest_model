"""Two-dimensional Euler-Bernoulli beam building model."""
...
from qrest_model.schema import BeamSectionConfig, EulerBeamModelConfig, GeometryConfig
from qrest_model.theory.euler_beam import assemble_matrices, base_excitation_influence


@dataclass(frozen=True)
class EulerBeam2DModel:
    sections: tuple[BeamSectionConfig, ...]
    geometry: GeometryConfig

    @classmethod
    def from_config(cls, config: EulerBeamModelConfig) -> "EulerBeam2DModel":
    ...
    def mass_matrix(self) -> np.ndarray:
        ...
        return validate_positive_definite_matrix(
            mass,
            label="Euler beam global mass matrix",
        )
    ...
    def stiffness_matrix(self) -> np.ndarray:
        ...
        return validate_positive_definite_matrix(
            stiffness,
            label="Euler beam global stiffness matrix",
        )
