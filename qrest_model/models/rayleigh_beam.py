"""Two-dimensional Rayleigh beam building model."""
...
from qrest_model.schema import BeamSectionConfig, GeometryConfig, RayleighBeamModelConfig
from qrest_model.theory.rayleigh_beam import assemble_matrices, base_excitation_influence


@dataclass(frozen=True)
class RayleighBeam2DModel:
    sections: tuple[BeamSectionConfig, ...]
    geometry: GeometryConfig

    @classmethod
    def from_config(cls, config: RayleighBeamModelConfig) -> "RayleighBeam2DModel":
    ...
    def mass_matrix(self) -> np.ndarray:
        ...
        return validate_positive_definite_matrix(
            mass,
            label="Rayleigh beam global mass matrix",
        )
    ...
    def stiffness_matrix(self) -> np.ndarray:
        ...
        return validate_positive_definite_matrix(
            stiffness,
            label="Rayleigh beam global stiffness matrix",
        )
