...
ModelCaseInput = ModelConfig | ShearModelConfig | dict[str, Any] | str | Path
...
def normalize_model_case(case: ModelCaseInput) -> ModelConfig | ShearModelConfig:
    if isinstance(case, (ModelConfig, ShearModelConfig)):
        return case
...
def dispatch_model_case(case: ModelCaseInput) -> tuple[str, ModelConfig | ShearModelConfig | str | Path]:
